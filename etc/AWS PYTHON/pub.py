...
#        tempreading = uniform(20.0,25.0)                        # Generating Temperature Readings 
        mqttc.publish("coisa1", inputValue, qos=1)        # topic: temperature # Publishing Temperature values
        print("msg sent: coisa1 " + inputValue ) # Print sent temperature msg on console
    else:
